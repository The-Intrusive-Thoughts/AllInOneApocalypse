...
public final class AioaScreenUtil {
    ...
    static void drawEntityViewport(GuiGraphics guiGraphics, Font font, int left, int top, int width, int height,
        ...
        if (entity != null) {
            ...
            InventoryScreen.renderEntityInInventoryFollowsMouse(guiGraphics, mobX, mobY, scale, orbitX, orbitY, entity);
            if (frame.showTarget() && width >= 230 && Minecraft.getInstance().player != null) {
                ...
                InventoryScreen.renderEntityInInventoryFollowsMouse(guiGraphics, targetScreenX, targetScreenY,
