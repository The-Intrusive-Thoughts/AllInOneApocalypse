...
final class AioaDocsScreen extends AioaAnimatedScreen {
    ...
    private void drawStartDocs(GuiGraphics g, int left, int top, int width) {
        ...
        AioaScreenUtil.drawMobPreview(g, this.font, left + 36, top + 76, 210, 150, ResourceLocation.fromNamespaceAndPath("minecraft", "zombie"), true,
    ...
    private void drawSpawnDocs(GuiGraphics g, int left, int top, int width) {
        ...
        AioaScreenUtil.drawMobPreview(g, this.font, left + 30, top + 78, 190, 145, ResourceLocation.fromNamespaceAndPath("minecraft", "skeleton"), true,
                List.of(Component.literal("INSTANCE PRESET"), Component.literal("No AI + face player")));
        AioaScreenUtil.drawMobPreview(g, this.font, left + 236, top + 78, 190, 145, ResourceLocation.fromNamespaceAndPath("minecraft", "creeper"), true,
